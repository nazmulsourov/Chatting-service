...
function sendFormData() {
    ...
    var formData = '<table border="1">'
        + '<caption>Policy Info</caption>'
        + '<tr><th>Policy holder name</th><td>' + name + '</td></tr>'
        + '<tr><th>Policy Id:</th><td>' + id + '</td></tr>'
        + '<tr><th>Policy holder mobile no:</th><td>' + mobile + '</td></tr>'
        + '<tr><th>Policy holder email:</th><td>' + email + '</td></tr>'
        + '</table>';
